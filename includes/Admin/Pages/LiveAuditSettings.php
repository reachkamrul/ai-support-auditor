...
class LiveAuditSettings {
    ...
    private function render_styles() {
        ...
        <style>
            ...
            .la-section-header h3 { margin: 0; font-size: 15px; font-weight: 600; }
            ...
            .la-radio-label { font-size: 14px; font-weight: 600; display: block; }
            .la-radio-desc {
                font-size: 12px; color: var(--color-text-tertiary, #94a3b8);
                margin-top: 2px;
            }
            .la-radio-extra {
            ...
            .la-radio-extra label { font-size: 12px; color: var(--color-text-secondary); }
            .la-radio-extra input { width: 60px; }

            .la-throttle-row {
                display: flex; align-items: center; gap: 10px;
            }
            .la-throttle-row label { font-size: 14px; font-weight: 500; }
            .la-throttle-row .ops-input { width: 80px; }
            .la-throttle-row .unit { font-size: 13px; color: var(--color-text-secondary); }
            ...
            .la-step-title { font-size: 14px; font-weight: 600; margin-bottom: 4px; }
            .la-step-desc { font-size: 12px; color: var(--color-text-tertiary, #94a3b8); line-height: 1.5; }
            .la-copy-row {
            ...
            .la-code-block {
                width: 100% !important; padding: 12px 14px !important; font-size: 12px !important;
...
MUCODE;
        ...
        <div class="ops-card">
            ...
            <p style="margin:0 0 14px;font-size:13px;color:var(--color-text-secondary);line-height:1.6;">
            ...
            <div class="la-setup-step">
                ...
                <div class="la-step-content">
                    <div class="la-step-title">Create "Ticket Closed" Workflow <span class="la-badge active" style="font-size:10px;padding:2px 8px;">Native</span></div>
            ...
            <div class="la-setup-step">
                ...
                <div class="la-step-content">
                    <div class="la-step-title">Install "Agent Response" Webhook <span class="la-badge" style="background:#eff6ff;color:#1e40af;font-size:10px;padding:2px 8px;">mu-plugin</span></div>
                    <div class="la-step-desc">
